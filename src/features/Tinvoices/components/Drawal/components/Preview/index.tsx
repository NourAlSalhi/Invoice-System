...
import { usePayInvoice } from "../../../../../invoices/contexts/PayInvoice";
import { useInvoicePreview } from "../../../../../invoices/hooks/useInvoicePreview";
...
const Preview: any = () => {
  ...
  return (
    <Card className="py-8 mb-4 border shadow-sm px-11">
      ...
      <div className="h-px my-3 bg-gray mb-3" />
      <div className="ml-auto max-w-max min-w-[160px] text-gray-dark text-sm  ">
        ...
        <div className="flex justify-between mt-3">
          <h1>Fees</h1>
          <span className="text-gray-dark">${fees}</span>
        </div>
        <div className="flex justify-between text-xl text-black mt-3">
